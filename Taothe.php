...
if ($s <10)
{
  $m= "BIKE CYCLE CARD 00".$s;
}
elseif ($s<100) 
{
  $m= "BIKE CYCLE CARD 0".$s;
}
else
{
  $m= "BIKE CYCLE CARD ".$s;
...
if (isset($_POST['taothe'])){
    ...
    $status =$_POST['status'];
    $card = $c_card->Taothemuon($code_card,$status);
}
?>
<!doctype html>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tạo Thẻ mượn</strong> 
                        </div>
                        <div class="card-body">
                  <div class="login-form" >
                    ...
                    <form method="POST">
                        <div class="form-group">
                            <label>Mã thẻ</label>
                            <input name="code_card" value="<?=$m?>" type="text" class="form-control" placeholder="ex. CART TT 001/CARD TS 001..">
                        </div>
                        <div class="form-group">
                        ...
                        <button name="taothe" type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Tạo thẻ</button>
                    </form>
                </div>
                        </div>
                    </div>
